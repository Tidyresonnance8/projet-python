class Figure:
    ...
    def surface(self):
        ...
        """
        raise NotImplementedError() # Non implémentée car la classe figure n'a pas de surface.
...
class Rectangle(Figure):
    ...
    def __str__(self) :
        return str((self.longueur, self.largeur, self.x_visible(), self.y_visible(), self.est_visible()))